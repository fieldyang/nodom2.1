...
export declare class Element {
     ...
     * @param module    模块
     */
    handleExpression(exprArr: Array<Expression | string>, module: Module): any;
    /**
      * 处理属性（带表达式）
      * @param module    模块
      */
     ...
     */
    handleAssets(el: HTMLElement | SVGElement): void;
    /**
     * 处理文本（表达式）
     * @param module    模块
     */
     ...
     */
    removeDirectives(directives: string | string[]): void;
    /**
     * 添加指令
     ...
     * @param dom 	子节点
     */
    add(dom: Element | Array<Element>): void;
    /**
     ...
     * 从html删除
     */
    removeFromHtml(module: Module, textNode?: boolean): void;
    /**
     * 移除子节点
     * @param dom   子dom
     */
    ...
    /**
         ...
         */
    hasStyle(styStr: string): any;
    /**
     * 添加style
     *  @param styStr style字符串
     */
    addStyle(styStr: string): void;
    /**
     * 删除style
     * @param styStr style字符串
     */
    removeStyle(styStr: string): void;
    /**
     * 是否拥有属性
     * @param propName  属性名
     */
     ...
     */
    compare(dst: Element, retArr: Array<ChangedDom>, deleteMap?: Map<string, Array<any>>, parentNode?: Element): void;
    /**
     * 添加事件
     * @param event         事件对象
     */
     ...
     * @param value     参数值
     */
    setTmpParam(key: string, value: any): void;
    /**
     * 获取临时参数
     * @param key       参数名
     * @returns         参数值
     ...
     * @param key       参数名
     */
    removeTmpParam(key: string): void;
    /**
     * 是否有临时参数
     * @param key       参数名
     */
    hasTmpParam(key: string): boolean;
    /**
     * 添加渲染附加操作
     * @param method    方法名
     * @param type      类型 before,after
     */
    addRenderOp(method: any, type: string): void;
    /**
     * 执行渲染附加操作
     * @param module    模块
     * @param type      类型 before,after
     */
    doRenderOp(module: Module, type: string): void;
}
